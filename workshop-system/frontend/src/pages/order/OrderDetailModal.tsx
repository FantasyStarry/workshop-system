      ...
      <div key={item.id} style={{ marginBottom: 24, padding: 16, border: '1px solid #f0f0f0', borderRadius: 8 }}>
        <h4 style={{ marginBottom: 12 }}>
          ...
          <Tag style={{ marginLeft: 8 }}
            color={item.productionStatus === 2 ? 'success' : item.productionStatus === 1 ? 'processing' : 'default'}>
                ...
                <>
                  ...
                  <Table dataSource={files} columns={[
                    ...
                    { title: '操作', render: (_: any, r: OrderFile) =>
                      <a onClick={() => { if (window.confirm('确定删除？')) handleDeleteFile(r.id); }}>删除</a> },
              ...
              children: (
                <div style={{ padding: '8px 0' }}>
                  {Object.values(groupedProgress.groups).length > 0
                    ...
                    : <div style={{ textAlign: 'center', padding: 40, color: '#999' }}>暂无生产记录</div>
                  }
                </div>
              ),
            },
